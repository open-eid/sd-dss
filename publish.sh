...
for submodule in dss-alert dss-asic-cades dss-asic-common dss-asic-xades dss-cades dss-certificate-validation-common dss-certificate-validation-dto dss-certificate-validation-rest-client dss-certificate-validation-rest dss-certificate-validation-soap-client dss-certificate-validation-soap dss-common-remote-converter dss-common-remote-dto dss-cookbook dss-crl-parser-stream dss-crl-parser-x509crl dss-crl-parser dss-detailed-report-jaxb dss-diagnostic-jaxb dss-document dss-enumerations dss-i18n dss-jacoco-coverage dss-jades dss-jaxb-parsers dss-model dss-pades-openpdf dss-pades-pdfbox dss-pades dss-policy-jaxb dss-server-signing-common dss-server-signing-dto dss-server-signing-rest-client dss-server-signing-rest dss-server-signing-soap-client dss-server-signing-soap dss-service dss-signature-dto dss-signature-remote dss-signature-rest-client dss-signature-rest dss-signature-soap-client dss-signature-soap dss-simple-certificate-report-jaxb dss-simple-report-jaxb dss-spi dss-test dss-timestamp-dto dss-timestamp-remote dss-timestamp-remote-rest dss-timestamp-remote-rest-client dss-timestamp-remote-soap dss-timestamp-remote-soap-client dss-token dss-tsl-validation dss-utils-apache-commons dss-utils-google-guava dss-utils dss-validation-dto dss-validation-rest-client dss-validation-rest dss-validation-server-common dss-validation-soap-client dss-validation-soap dss-xades specs-asic-manifest specs-jades specs-jws specs-saml-assertion specs-trusted-list specs-validation-report specs-xades specs-xmldsig validation-policy
do
