...
public class BDocTmSupport implements Serializable {
  ...
  public static boolean hasBDocTmPolicyId(Element signatureElement, XAdESPath xadesPaths) {
  ...
  public static boolean hasBDocTmOcsp(Element signatureElement, XAdESPath xadesPaths) {
